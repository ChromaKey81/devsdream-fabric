...
// import net.devsdream.objectpack.customized.block.CustomizedBlock;
...
//         MapColor mapColor = ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object, "map_color"), "map color",
//                 mapColors);

//         PistonBehavior pistonBehavior = ChromaJsonHelper.getFromMapSafe(
//                 ChromaJsonHelper.getStringOrDefault(object, "push_reaction", "normal"), "push reaction",
//                 pistonBehaviors);
...
//         Material material = ChromaJsonHelper.getFromMapSafe(new Identifier(JsonHelper.getString(object, "material")),
...
//                 return ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object, "map_color"), "map color",
//                         mapColors);
...
//                 // return new AmethystClusterBlock(ChromaJsonHelper.getIntOrDefault(object,
//                 // "height", 0),
...
//                 // "Expected a block of a type which extends the abstract
//                 // minecraft:stem_grown");
//                 // } else {
...
//                 // }
//                 // case "banner": {
//                 // return new BannerBlock(ChromaJsonHelper.getDyeColor(object, "dye_color"),
//                 // settings);
//                 // }
//                 // case "barrel": {
...
//                 // }
//                 // case "campfire": {
//                 // return new CampfireBlock(ChromaJsonHelper.getBooleanOrDefault(object,
...
//                 // }
//                 // case "chest": {
//                 // BlockEntityType<?> blockEntityType = ChromaJsonHelper.getBlockEntity(object,
//                 // "block_entity");
...
//                 // }
//                 // case "command": {
//                 // return new CommandBlock(settings,
//                 // ChromaJsonHelper.getBooleanOrDefault(object, "auto", false));
//                 // }
//                 // case "comparator": {
...
//                 // return new ConcretePowderBlock(ChromaJsonHelper.getBlock(object, "concrete"),
//                 // settings);
//                 // }
//                 // case "conduit": {
...
//                 // }
//                 // case "pipe": {
//                 // return new ConnectingBlock(ChromaJsonHelper.getFloatOrDefault(object,
//                 // "radius", 0), settings);
//                 // }
//                 // case "coral": {
//                 // return new CoralBlock(ChromaJsonHelper.getBlock(object, "dead_block"),
//                 // settings);
//                 // }
//                 // case "coral_plant": {
//                 // return new CoralBlockBlock(ChromaJsonHelper.getBlock(object, "dead_block"),
//                 // settings);
//                 // }
//                 // case "coral_fan": {
//                 // return new CoralFanBlock(ChromaJsonHelper.getBlock(object, "dead_block"),
//                 // settings);
//                 // }
...
//                 // }
//                 // case "coral_wall_fan": {
//                 // return new CoralWallFanBlock(ChromaJsonHelper.getBlock(object, "dead_block"),
//                 // settings);
//                 // }
//                 // case "crafting_table": {
...
//                 // }
//                 // case "wool_carpet": {
//                 // return new DyedCarpetBlock(ChromaJsonHelper.getDyeColor(object, "dye_color"),
//                 // settings);
//                 // }
...
//                 // }
//                 // case "flower": {
//                 // return new FlowerBlock(ChromaJsonHelper.getEffect(object,
//                 // "suspicious_stew_effect"),
//                 // ChromaJsonHelper.getInt(object, "effect_duration"), settings);
//                 // }
//                 // case "flower_pot": {
//                 // return new FlowerPotBlock(ChromaJsonHelper.getBlockOrDefault(object, "block",
//                 // Blocks.AIR),
//                 // settings);
//                 // }
//                 case "liquid": {
...
//                         return new FluidBlock((FlowableFluid) ChromaJsonHelper.getFluid(object, "flowing_fluid"),
//                                 settings);
//                     } else {
...
//                 // JsonHelper.getFloat(object, "radius_2"), JsonHelper.getFloat(object,
//                 // "bounding_height_1"),
...
//                 // Object2ObjectOpenHashMap<Item, CauldronBehavior> behaviorMap =
//                 // (Object2ObjectOpenHashMap<Item, CauldronBehavior>) Util
...
//                                 .getOrThrow(false, (error) -> {
//                                     error = new String("Could not parse "
//                                             + JsonHelper.getString(featureObj, "id" + " with configuration"));
//                                 });
//                     });
//                 }
//                 // case "mycelium": {
...
//                 // }
//                 case "ore": {
//                     JsonObject uniformProvider = ChromaJsonHelper.getObjectOrDefault(object, "uniform_xp_provider",
//                             new JsonObject());
//                     if (!uniformProvider.has("min")) {
//                         uniformProvider.addProperty("min", 0);
//                     }
//                     if (!uniformProvider.has("max")) {
//                         uniformProvider.addProperty("max", 0);
//                     }
//                     return new OreBlock(settings, UniformIntProvider.create(JsonHelper.getInt(uniformProvider, "min"),
//                             JsonHelper.getInt(uniformProvider, "max")));
//                 }
//                 // case "weathering_copper_full": {
//                 // return new
//                 // OxidizableBlock(ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object,
//                 // "weather_state"), "weather state", weatherStates), settings);
//                 // }
//                 // case "weathering_copper_slab": {
//                 // return new
//                 // OxidizableSlabBlock(ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object,
//                 // "weather_state"), "weather state", weatherStates), settings);
//                 // }
//                 // case "weathering_copper_stair": {
//                 // if (object.get("base").isJsonObject()) {
//                 // return new
//                 // OxidizableStairsBlock(ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object,
//                 // "weather_state"), "weather state", weatherStates),
//                 // BlockState.CODEC.parse(JsonOps.INSTANCE, JsonHelper.getObject(object,
//                 // "base"))
//                 // .getOrThrow(false, (error) -> {
...
//                 }
//                 // case "piston_base": {
//                 // return new PistonBlock(ChromaJsonHelper.getBooleanOrDefault(object, "sticky",
//                 // false), settings);
//                 // }
//                 // case "moving_piston": {
...
//                 // switch (ChromaJsonHelper.getStringOrDefault(object, "sensitive_to",
//                 // "everything")) {
//                 // case "everything": {
...
//                 // }
//                 // default: {
//                 // throw new JsonSyntaxException("Expected either 'everything' or 'mobs' for
//                 // type");
//                 // }
//                 // }
...
//                     return new RotatedInfestedBlock(ChromaJsonHelper.getBlock(object, "regular_block"), settings);
//                 }
//                 case "sand": {
...
//                 // }
//                 // case "shulker_box": {
//                 // return new ShulkerBoxBlock(ChromaJsonHelper.getDyeColorOrDefault(object,
//                 // "color", null), settings);
//                 // }
...
//                 // case "skull": {
//                 // return new
//                 // SkullBlock(ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object,
//                 // "skull_type"), "skull type", skullTypes), settings);
//                 // }
//                 case "slab": {
...
//                 // }
//                 // case "stained_glass": {
//                 // return new StainedGlassBlock(ChromaJsonHelper.getDyeColor(object,
//                 // "dye_color"), settings);
//                 // }
//                 // case "stained_glass_pane": {
//                 // return new StainedGlassPaneBlock(ChromaJsonHelper.getDyeColor(object,
//                 // "dye_color"), settings);
//                 // }
//                 case "stair": {
//                     if (object.get("base").isJsonObject()) {
...
//                 // }
//                 // case "trip_wire": {
//                 // Block tripwireHook = ChromaJsonHelper.getBlock(object,
//                 // "tripwire_hook_block");
...
//                 // }
//                 // case "wall_banner": {
//                 // return new WallBannerBlock(ChromaJsonHelper.getDyeColor(object, "color"),
//                 // settings);
//                 // }
//                 case "wall": {
...
//                 // case "wall_skull": {
//                 // return new
//                 // WallSkullBlock(ChromaJsonHelper.getFromMapSafe(JsonHelper.getString(object,
//                 // "skull_type"), "skull type", skullTypes), settings);
//                 // }
//                 // case "wall_torch": {
...
//                 // return new WeightedPressurePlateBlock(JsonHelper.getInt(object, "weight"),
//                 // settings);
//                 // }
//                 // case "wet_sponge": {
...
//                 // }
//                 // case "wither_rose": {
//                 // return new WitherRoseBlock(ChromaJsonHelper.getEffect(object, "effect"),
//                 // settings);
//                 // }
//                 // case "wither_skull": {
...
//                 // }
//                 default: {
//                     throw new JsonSyntaxException("Unknown block type");
//                 }
//             }
//         } else if (type.getIdentifier().toString().equals("devsdream:customized")) {
//             return new CustomizedBlock(
//                     settings,
//                     new BlockType(new Identifier("devsdream:customized"),
//                             JsonHelper.getObject(object, "custom_properties")));
//         } else {
//             throw new JsonSyntaxException("Unknown block type");
//         }
//     }
